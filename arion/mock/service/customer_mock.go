...
func (m *MockCustomerService) GetCustomersByShopID(shopID int) ([]response.CustomerData, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCustomerServiceMockRecorder) GetCustomersByShopID(shopID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCustomersByShopID", reflect.TypeOf((*MockCustomerService)(nil).GetCustomersByShopID), shopID)
}
